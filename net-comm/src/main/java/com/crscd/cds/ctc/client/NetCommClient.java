...
import com.crscd.cds.ctc.handler.NetCommChannelInitializer;
...
public class NetCommClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(NetCommClient.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        FilterRegister.ClientAddress address =
                FilterRegister.ClientAddress.create(0x01, 0x02, 0x01);
        ...
        NetCommClient nettyClient =
                new NetCommClient(
                        "10.2.54.251", 8001, localAddress, register, null, ClientFlagEnum.NET1);
        nettyClient.start();
        ...
        bytes[8] = 0x01;
        bytes[9] = 0x01;
        ApplicationData protocolBase =
                ApplicationData.create((short) 0x01, (short) 0x01, bytes, null);
            ...
            channel.close()
                    .addListener(
                            new ChannelFutureListener() {
                                ...
                                public void operationComplete(ChannelFuture channelFuture) {
                                    LOGGER.info(
                                            "close manually to {} and result is {}",
                                            channel,
                                            channelFuture.isSuccess());
                                }
                            });
