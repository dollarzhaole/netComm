...
public class NetCommChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    private final NetCommClient client;
    ...
    protected void initChannel(SocketChannel ch) {
        ...
        pipeline.addLast(
                new LengthFieldBasedFrameDecoder(
                        ...
                        true));
        pipeline.addLast(
                new PackageChannelInboundHandler(
                        flowController,
                        register,
                        localAddress,
                        doubleNetController,
                        registerController));
        pipeline.addLast(new DoubleNetSequenceInboundHandler(netFlag, doubleNetController));
