...
public class NetCommListenerAnnotationBeanPostProcessor implements BeanPostProcessor, BeanFactoryAware {
    ...
    private void processNetCommListener(NetCommListener annotation, Object bean, Method method) {
        ...
        Assert.notEmpty(parameterTypes, "@NetCommListener's method should has at lest one parameter");
        Class<?> parameterType = parameterTypes[0];
        Assert.isTrue(MessageContent.class.isAssignableFrom(parameterType),
        ...
        SimpleMessageListenerContainer listenerContainer = containerFactory.createListenerContainer(
                ...
                func,
                pt,
                message -> useMethod.invoke(bean, message));
